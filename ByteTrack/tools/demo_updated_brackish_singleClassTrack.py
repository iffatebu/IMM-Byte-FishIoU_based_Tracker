...
def make_parser():
    ...
    parser.add_argument("-f",
                        ...
                        default="scratch/morrill/users/ie93/ByteTrack/exps/example/mot/yolox_x_ablation_brackish.py",
                        type=str,
    ...
    parser.add_argument("-c",
                        ...
                        default="/scratch/morrill/users/ie93/ByteTrack/YOLOX_outputs/yolox_x_ablation_brackish/latest_ckpt.pth.tar",
                        type=str,
                        help="ckpt for eval")
    ...
    parser.add_argument("--path",
                        ...
                        default="/scratch/morrill/users/ie93/ByteTrack/datasets/BrackishMOT/test",
...
def run(exp, opt):
    ...
    if opt.save_result:
        ...
        vis_dir = os.path.join(file_name, "/scratch/morrill/users/ie93/ByteTrack/YOLOX_outputs/yolox_x_ablation_brackish/vis")
        ...
        result_root = os.path.join(file_name, "/scratch/morrill/users/ie93/ByteTrack/YOLOX_outputs/yolox_x_ablation_brackish/results")
